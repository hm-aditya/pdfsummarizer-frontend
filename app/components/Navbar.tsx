      ...
      <Link href="/" className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
            <button className="px-4 py-2 bg-black text-white rounded-lg cursor-pointer">
                <Link href="https://www.buymeacoffee.com/hm_aditya" className="flex items-center gap-2">
                    <span className="hidden md:block">Buy me a coffee</span> <CoffeeIcon className="w-5 h-5 text-blue-400" />
                </Link>
            </button>
              <div>
            <button className="px-4 py-2 bg-black text-white rounded-lg cursor-pointer">
                <Link href="https://www.buymeacoffee.com/hm_aditya" className="flex items-center gap-2">
                    <span className="hidden md:block">Star my repository</span> <StarIcon className="w-5 h-5 text-blue-400" />
                </Link>
            </button>
        </div>
        </div>
